...
export const insertJobSchema = createInsertSchema(jobs).omit({
  ...
  status: z.enum(["pending", "active", "planning", "in_progress", "completed", "cancelled", "archived"]).default("pending"),
...
export const subcontractPayoutAudit = pgTable("subcontract_payout_audit", {
  ...
  secondTransferAmountCents: integer("second_transfer_amount_cents"),
  secondStripeTransferId: varchar("second_stripe_transfer_id"),
  secondDestinationAccountId: varchar("second_destination_account_id"),
  secondSubcontractorCompanyId: integer("second_subcontractor_company_id"),
