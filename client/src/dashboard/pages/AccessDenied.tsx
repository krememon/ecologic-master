      ...
      <div className="max-w-md text-center">
        ...
        {email ? (
          <p className="text-sm text-slate-500">
            Your account ({email}) is not authorized to view this dashboard.
          </p>
        ) : (
          <p className="text-sm text-slate-500">
        ...
        <p className="text-xs text-slate-400 mt-4">
          If you believe this is a mistake, contact the EcoLogic owner to be added
          to the admin allow-list.
        </p>
      </div>
    </div>
  );
