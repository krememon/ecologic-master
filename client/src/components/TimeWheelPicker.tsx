  ...
  return (
    <>
      <button
        ...
        className={`w-full h-10 flex items-center justify-between px-3 border rounded-xl bg-background border-input text-base md:text-sm text-left focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-0 ${className || ''}`}
      >
