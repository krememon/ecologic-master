  ...
  return (
    <>
      ...
      <Dialog open={scheduleModalOpen} onOpenChange={setScheduleModalOpen}>
        <DialogContent className="w-[95vw] max-w-md p-0 gap-0 rounded-2xl overflow-hidden" hideCloseButton>
          ...
          <div className="px-4 py-3 border-t border-slate-100 dark:border-slate-800">
            <Button onClick={() => setScheduleModalOpen(false)} className="w-full h-10 rounded-xl">
              Done
            </Button>
          </div>
        </DialogContent>
      ...
      <Dialog open={employeesModalOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="w-[95vw] max-w-md p-0 gap-0 rounded-2xl overflow-hidden" preventAutoFocus hideCloseButton>
          <div className="flex items-center justify-between px-4 h-14 border-b border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800">
            <div className="min-w-[44px]" />
