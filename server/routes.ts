  ...
  app.post('/api/billing/verify-checkout-session', isAuthenticated, async (req: any, res) => {
    try {
      ...
      await syncSubscriptionToCompany(company.id, {
        ...
        trial_end: typeof (fullSub as any).trial_end === 'number' ? (fullSub as any).trial_end : null,
        items: fullSub.items,
  ...
  app.post('/api/billing/switch-plan', isAuthenticated, async (req: any, res) => {
    try {
      ...
      await syncSubscriptionToCompany(company.id, {
        ...
        trial_end: typeof (updatedSub as any).trial_end === 'number' ? (updatedSub as any).trial_end : null,
